...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self.viewController PrepareLoadingAnimation];
...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [self.viewController onFinishedLoadingAnimation:nil];
    [self.viewController PrepareLoadingAnimation];
}
...
-(void)showLoadingAnimation
{
    ...
    {
        isFirstLoading = NO;
        [NSTimer scheduledTimerWithTimeInterval:0.3 target:self selector:@selector(showLoadingAnimation) userInfo:nil repeats:NO];
    }
    else
    {
